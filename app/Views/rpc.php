...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data RPC</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nama_rpc" class="col-form-label"> Nama rpc: <span class="text-danger">*</span> </label>
                <textarea cols="40" rows="5" id="nama_rpc" name="nama_rpc" class="form-control" placeholder="Nama rpc" minlength="0" required></textarea>
              </div>
            </div>
          </div>
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #nama_rpc").val(response.nama_rpc);
