...
<section class="content mb-0">
    <div class="box">
        ...
        <div class="box-body">
            <?= form_open_multipart('Vyc/importData') ?>
            <?php
...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data YYC</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="rpc_id" class="col-form-label"> Nama RPC: <span class="text-danger">*</span> </label>
                <select id="rpc_id" name="rpc_id" class="form-select select2 " required>
                  <option value="">Pilih RPC</option>
                  <?php foreach ($rpc as $key => $value) : ?>
                    <option value="<?= $value->id ?>"><?= $value->nama_rpc ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nilai_vyc" class="col-form-label"> Nilai VYC: <span class="text-danger">*</span> </label>
                <input type="text" id="nilai_vyc" name="nilai_vyc" class="form-control" placeholder="Nilai VYC" minlength="0" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="bulan" class="col-form-label"> Bulan: <span class="text-danger">*</span> </label>
                <input type="number" id="bulan" name="bulan" class="form-control" placeholder="Bulan" minlength="0" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #rpc_id").val(response.rpc_id);
          $("#data-form #nilai_vyc").val(response.nilai_vyc);
